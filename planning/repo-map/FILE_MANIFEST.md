...
| [`workflows/README.md`](file:///Users/victor/Dev/Local-N8n/workflows/README.md) | Markdown | 52 | Workflows directory index, active & archived pipeline inventory, and Data Tables reference. |
| [`workflows/meshnet-health-check/workflow.json`](file:///Users/victor/Dev/Local-N8n/workflows/meshnet-health-check/workflow.json) | JSON | 77 | Exported JSON definition for Meshnet-Health-Check workflow (`XRDcHq3GIEZQKprT`). |
...
| [`workflows/ai-testing/workflow.json`](file:///Users/victor/Dev/Local-N8n/workflows/ai-testing/workflow.json) | JSON | 215 | Exported JSON definition for AI-TESTING workflow (`5rRB16PM6Tx07ZB0`) configured with Hulk LM Studio (`http://100.64.153.30:1234/v1`), multi-agent comparison, and SearXNG Web Search tool. |
| [`workflows/ai-testing/README.md`](file:///Users/victor/Dev/Local-N8n/workflows/ai-testing/README.md) | Markdown | 58 | Documentation and architecture for AI-TESTING flow. |
| [`workflows/slack/workflow.json`](file:///Users/victor/Dev/Local-N8n/workflows/slack/workflow.json) | JSON | 145 | Exported JSON definition for Slack ingress router (`8irpSdMtOgDVxsSb`). |
| [`workflows/slack/README.md`](file:///Users/victor/Dev/Local-N8n/workflows/slack/README.md) | Markdown | 45 | Documentation and architecture for Slack ingress router. |
| [`workflows/slack-ai-agent/workflow.json`](file:///Users/victor/Dev/Local-N8n/workflows/slack-ai-agent/workflow.json) | JSON | 55 | Exported JSON definition for slack-ai-agent bridge (`Fq6gdZ5X10eOiCQA`). |
| [`workflows/slack-ai-agent/README.md`](file:///Users/victor/Dev/Local-N8n/workflows/slack-ai-agent/README.md) | Markdown | 40 | Documentation for slack-ai-agent bridge calling native Tirano. |
| [`workflows/tool-searxng-search/workflow.json`](file:///Users/victor/Dev/Local-N8n/workflows/tool-searxng-search/workflow.json) | JSON | 55 | Exported JSON definition for Tool-SearXNG-Search sub-workflow (`hk8OViFZWBnveSCF`). |
...
| [`workflows/sub-agent-calendar-manager/workflow.json`](file:///Users/victor/Dev/Local-N8n/workflows/sub-agent-calendar-manager/workflow.json) | JSON | 212 | Exported JSON definition for Calendar Sub-Agent (`xFn1G3NIcSn5TnMK`, archived/staged). |
| [`workflows/reminder-poller/workflow.json`](file:///Users/victor/Dev/Local-N8n/workflows/reminder-poller/workflow.json) | JSON | 145 | Exported JSON definition for Reminder Poller (`RZlNxQ7seruMJccB`, archived/staged). |
| [`workflows/calendar-native-agent/workflow.json`](file:///Users/victor/Dev/Local-N8n/workflows/calendar-native-agent/workflow.json) | JSON | 198 | Exported JSON definition for Calendar Native Agent (`ahZnfDnp0564f7YS`, archived/staged). |
| [`agents/README.md`](file:///Users/victor/Dev/Local-N8n/agents/README.md) | Markdown | 39 | Native n8n Agents inventory, architectural standards, and synchronization scripts. |
| [`agents/tirano/agent.json`](file:///Users/victor/Dev/Local-N8n/agents/tirano/agent.json) | JSON | 60 | Exported native agent definition for Tirano (`OeEDzKbhvVK7aqeT`, Rev 30). |
...
| [`agents/tirano-gemini/agent.json`](file:///Users/victor/Dev/Local-N8n/agents/tirano-gemini/agent.json) | JSON | 60 | Exported native agent definition for tirano-gemini (`dEeAUYYsM5pxxKH9`, Rev 3). |
...
| [`scripts/export-workflows.js`](file:///Users/victor/Dev/Local-N8n/scripts/export-workflows.js) | JavaScript | 64 | Automated script exporting all n8n workflows via REST API to local directories. |
| [`scripts/export-agents.js`](file:///Users/victor/Dev/Local-N8n/scripts/export-agents.js) | JavaScript | 45 | Automated script exporting native agents directly from PostgreSQL to local JSON definitions. |
| [`scripts/backup-pull.sh`](file:///Users/victor/Dev/Local-N8n/scripts/backup-pull.sh) | Shell | 261 | Zero-trust backup pull script streaming live Postgres dump, Docker volumes, and host state snapshot over Meshnet via root backup helper. |
| [`server-scripts/backup-docker-stream.sh`](file:///Users/victor/Dev/Local-N8n/server-scripts/backup-docker-stream.sh) | Shell | 42 | Least-privilege root backup helper installed to `/opt/scripts/backup-docker-stream.sh` allowing `silver-worker` via sudoers to stream PostgreSQL dumps and Docker volumes without `/var/run/docker.sock` access. |
